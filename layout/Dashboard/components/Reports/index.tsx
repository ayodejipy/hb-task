			...
			<div className="flex items-center justify-between space-x-12">
				<div className="flex items-center w-52 space-x-6">
					...
					<div className="flex items-center space-x-2">
						<span className={`"font-medium text-sm hover:text-blue-aud ${ active ? 'text-blue-aud' : 'text-[#304156]'}"`}>February Report</span>
						{isNew && (
				...
				<span className="font-medium text-sm text-gray-500">4th, October 2021  11:20am</span>
			</div>
